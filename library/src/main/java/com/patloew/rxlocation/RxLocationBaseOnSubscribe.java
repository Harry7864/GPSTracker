...
abstract class RxLocationBaseOnSubscribe<T> {
    ...
    protected RxLocationBaseOnSubscribe( RxLocation rxLocation, Long timeout, TimeUnit timeUnit) {
    ...
    protected RxLocationBaseOnSubscribe( Context ctx,  Api<? extends Api.ApiOptions.NotRequiredOptions>[] services, Scope[] scopes) {
        this.ctx = ctx;
