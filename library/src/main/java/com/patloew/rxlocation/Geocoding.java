...
public class Geocoding {
    ...
    public Single<List<Address>> fromLocation(Locale locale,  Location location, int maxResults) {
    ...
    public Maybe<Address> fromLocationName(Locale locale,  String locationName, double lowerLeftLatitude, double lowerLeftLongitude, double upperRightLatitude, double upperRightLongitude) {
    ...
    public Single<List<Address>> fromLocationName(Locale locale,  String locationName, int maxResults, double lowerLeftLatitude, double lowerLeftLongitude, double upperRightLatitude, double upperRightLongitude) {
    ...
    public Maybe<Address> fromLocationName(Locale locale,  String locationName) {
    ...
    public Single<List<Address>> fromLocationName(Locale locale,  String locationName, int maxResults) {
