...
public class LocationSettings {
    ...
    public Single<LocationSettingsResult> check( LocationRequest locationRequest, long timeoutTime,  TimeUnit timeoutUnit) {
    ...
    public Single<LocationSettingsResult> check( LocationSettingsRequest locationSettingsRequest, long timeoutTime,  TimeUnit timeoutUnit) {
    ...
    public Completable checkAndHandleResolutionCompletable( LocationRequest locationRequest, long timeoutTime,  TimeUnit timeoutUnit) {
    ...
    public Single<Boolean> checkAndHandleResolution( LocationRequest locationRequest, long timeoutTime,  TimeUnit timeoutUnit) {
    ...
    public Completable checkAndHandleResolutionCompletable( LocationSettingsRequest locationSettingsRequest) {
    ...
    public Completable checkAndHandleResolutionCompletable( LocationSettingsRequest locationSettingsRequest, long timeoutTime,  TimeUnit timeoutUnit) {
    ...
    public Single<Boolean> checkAndHandleResolution( LocationSettingsRequest locationSettingsRequest, long timeoutTime,  TimeUnit timeoutUnit) {
