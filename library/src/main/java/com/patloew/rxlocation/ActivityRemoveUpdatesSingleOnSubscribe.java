...
class ActivityRemoveUpdatesSingleOnSubscribe extends RxLocationSingleOnSubscribe<Status> {
    ...
    ActivityRemoveUpdatesSingleOnSubscribe( RxLocation rxLocation, PendingIntent pendingIntent, Long timeout, TimeUnit timeUnit) {
    ...
    protected void onGoogleApiClientReady(GoogleApiClient apiClient, SingleEmitter<Status> emitter) {
        ...
        setupLocationPendingResult(ActivityRecognition.ActivityRecognitionApi.removeActivityUpdates(apiClient, pendingIntent),
