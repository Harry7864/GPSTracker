...
public class GoogleApiClientFlowable extends RxLocationFlowableOnSubscribe<GoogleApiClient> {
    ...
    @SafeVarargs
    public static Flowable<GoogleApiClient> create( Context context,  Api<? extends Api.ApiOptions.NotRequiredOptions>... apis) {
        return Flowable.create(new GoogleApiClientFlowable(context, apis, null), BackpressureStrategy.LATEST);
    }

    public static Flowable<GoogleApiClient> create( Context context,  Api<? extends Api.ApiOptions.NotRequiredOptions>[] apis, Scope[] scopes) {
