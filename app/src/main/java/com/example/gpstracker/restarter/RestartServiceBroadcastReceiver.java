...
package com.example.gpstracker.restarter;
...
import com.example.gpstracker.Globals;
import com.example.gpstracker.ProcessMainClass;
...
public class RestartServiceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        android.util.Log.d(TAG, "about to start timer " + context.toString());
    ...
    public static void reStartTracker(Context context) {
        ...
        android.util.Log.i(TAG, "Restarting tracker");
